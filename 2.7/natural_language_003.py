...
'''
For this exercize it was imposible to write it down from their examples, so I had to take 
the downloadedable script.  The downlader is the same as from v004, however, the summarize()
function doesn't work as described in the lesson.  I've gone through it a little bit, but
I've yet to really break down why it is reporting what it does (which is heavily dependent 
on nltk and beautifulSoup
'''
...
class FrequencySummarizer:
    ...
    def summarize(self, text, n):
        ...
        # create an empty dictionary (of the superior defaultdict variety) to hold the rankings of the 
            # sentences. 
        for i,sent in enumerate(word_sent):            # Indentation changes - we are inside the for loop. Oh! and this is a different type of for loop
...
summary = fs.summarize(textOfUrl[0], 1)
